		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <li class="nav-item dropdown active">
                ...
                <a class="dropdown-item" href="dropdown-kontak.php">Kontak</a>
								<a class="dropdown-item active" href="dropdown-tentang.php">Tentang</a>
          ...
          <aside class="single_sidebar_widget author_widget">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>Tentang Kami</h3>
                    <p class="lead">
                      Semoga website ini dapat membantu Rumah Sakit Baladhika Husada (DKT) Jember dalam monitoring infus pasien.
                    </p>
                </div>
              </div><!-- end title -->
          </aside>
              ...
              Mewujudkan peningkatan aksesibilitas pelayanan pendidikan dan kesehatan yang berkualitas dan terjangkau.
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="inner-hmv">
						...
						<p>
              Mengedepankan partisipasi dan menumbuhkembangkan kreatifitas masyarakat dalam pembangunan.
            </p>
					</div>
				</div>
			</div>
