  ...
  <header class="top-navbar">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <li class="nav-item active dropdown">
                ...
                <a class="dropdown-item active" href="dropdown-kontak.php">Kontak</a>
        ...
        <div class="container">
          <center>
            <aside class="single_sidebar_widget author_widget">
                <img style="width: 200px;" class="author_img" src="images/rs-dktjember.jpg">
                <br> <br>
                <h2>Rumah Sakit Baladhika Husada (DKT) Jember</h2>
                <h3>Jl. Panglima Besar Sudirman No. 49, Patrang, Jember, Jawa Timur 68118, Indonesia.</h3>
                <h4>(0331) 484674 - rsbaladhikahusada@yahoo.co.id</h4>
                <br>
                <div class="social_icon">
                  <a href="facebook.com/sulton.a.n"><i class="fa fa-facebook"></i></a> &emsp;
                  <a href="instagram.com/sultonainunn"><i class="fa fa-instagram"></i></a> &emsp;
                  <a href="#"><i class="fa fa-twitter"></i></a> &emsp;
                </div>
                <br>
                <h3>Patuhi 3 Himbauan Pemerintah: <br>
                  1. Kerja dari rumah &emsp; <br>
                  2. Sekolah dari rumah <br>
                  3. Ibadah di rumah &emsp;
                </h3>
                <div class="br"></div>
            </aside>
          </center>
