...
<body class="host_version">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbars-host">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active"><a class="nav-link" href="adminDashboard.php">Beranda</a></li>
            <li class="nav-item"><a class="nav-link" href="adminDenah.php">Denah</a></li>
  ...
  <div class="container text-center">
    <br>
      <h2>Data Infus RS Baladhika Husada (DKT) Jember</h2>
      <input type="button" value="Tambah Ruangan" class="btn btn-primary">
    <br> <br>
      <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
          <?php
          $no = 1;
            while ($infus = mysqli_fetch_array($get_data)) {
              ?>
              <?php
              $a = $infus['status'];
              if($a == "Penuh"){
              ...
              ?>
                <tr>
                    ...
                    <td><?= $infus['ruangan'] ?></td>
                    <td><?= $infus['no_ranjang'] ?></td>
                    <td> <button type="button" class="btn btn-link" <?php echo "$color"; ?>> <?= $infus['status'] ?> </button> </td>
                </tr>
                <?php
                $no++;
              }
